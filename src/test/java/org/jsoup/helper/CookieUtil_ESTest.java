...
public class CookieUtil_ESTest extends CookieUtil_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("", "wQes}ce[mTtro");
      ...
      try { 
        ...
        fail("Expecting exception: MalformedURLException");
         ...
         //
         // Illegal character in path at index 10: file:/wQes}ce[mTtro
         //
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        CookieUtil.storeCookies(httpConnection_Request0, (URL) null, map0);
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("PZAHak:6\"iSc5Y");
      URL uRL0 = mockFile0.toURL();
      try { 
        ...
        fail("Expecting exception: MalformedURLException");
         ...
         //
         // Illegal character in path at index 44: file:/home/ali/Desktop/emna/jsoup-2/PZAHak:6\"iSc5Y
         //
         verifyException("org.jsoup.helper.CookieUtil", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      Connection.Request connection_Request0 = httpConnection_Request0.cookie("LT^\"%G%{V8G", "LT^\"%G%{V8G");
      HttpURLConnection httpURLConnection0 = mock(HttpURLConnection.class, new ViolatedAssumptionAnswer());
